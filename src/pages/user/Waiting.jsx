    ...
    <>
      ...
      <div className="w-9/12 bg-white border-l">
        <div className="mx-10 pt-2">
          <span className="inline-block font-semibold text-2xl text-gray-700 ml-12 lg:ml-12 md:ml-12 sm:ml-8 pb-2 mt-3">Your Books</span></div>
              ...
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                ...
                <div className="flex-grow sm:pl-8">
                  ...
                  <div className="flex mb-4 mt-2">
                    <a className="bg-blue-400 px-6 rounded-full py-2 text-white" >Detail</a>
                  </div>
                </div>
              </div>
            </div>
