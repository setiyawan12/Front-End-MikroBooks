    ...
    return (
        ...
        <div className="flex flex-wrap bg-white w-full">
          <div className="w-9/12 bg-white rounded p-3">
            <span className="inline-block font-semibold text-xl text-gray-500 ml-5 lg:ml-2 md:ml-12 sm:ml-8 pb-4">Browser</span>
            <div className="flex flex-wrap -m-4">
              {this.state.books.map((books) =>(
                            <div key={books.id_books} className="p-4 lg:w-1/3">
                            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                              <Link to="/description" >
                                <img alt="team" className="flex-shrink-0 rounded-lg w-32 h-36 object-cover object-center sm:mb-0 mb-4" src="https://res.cloudinary.com/setiyawan/image/upload/v1614186202/plugin/image_12_rvbetu.png" />
                              </Link>
                              <div className="flex-grow sm:pl-8">
                                <h2 className="title-font font-bold text-gray-700">{books.title}</h2>
                                <h3 className="text-gray-500 mb-3">{books.publisher}</h3>
