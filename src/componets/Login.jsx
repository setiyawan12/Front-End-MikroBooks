        ...
        <section className="text-gray-600 body-font relative">
          <div className="mx-auto flex sm:flex-nowrap flex-wrap h-screen">
            <div className="lg:w-2/5 md:w-1/2 bg-blue-600 overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative flex-col text-white">
              ...
              <a className="mx-auto px-16 lg:mt-20 md:mt-12 sm:mt-6 text-white bg-login py-2 focus:outline-none hover:bg-blue-800 border-solid rounded-3xl text-lg border border-white hover:border-transparent">Sign Up</a>
            </div>
            <div className="lg:w-3/5 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
              ...
              <Link to="/home">
              <button><a className="mx-auto px-16 lg:mt-24 md:mt-12 sm:mt-6 text-white py-2 focus:outline-none hover:bg-blue-800 bg-blue-800 border-solid rounded-3xl text-lg border border-white hover:border-transparent">Login</a></button>
              </Link>
            </div>
          </div>
        </section>
